    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Meta Data Variabel</li>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="konsep" class="form-control" style="height: 100px" spellcheck="false" placeholder="Konsep"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="definisi" name="definisi" type="text" class="form-control" placeholder="Definisi">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="referensi_pemilihan" name="referensi_pemilihan" type="text" class="form-control" placeholder="Referensi Pemilihan">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input id="referensi_waktu" name="referensi_waktu" type="datetime-local" class="form-control" placeholder="Referensi Waktu">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="klasifikasi_isian" class="form-control" style="height: 100px" spellcheck="false" placeholder="Klasifikasi Isian"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="aturan_validasi" class="form-control" style="height: 100px" spellcheck="false" placeholder="Aturan Validasi"></textarea>
                                </div>
                            </div>
