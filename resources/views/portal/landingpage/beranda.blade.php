    ...
    <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
            <div class="col-md-6 py-5 wow fadeInLeft">
                ...
                <p class="text-lg text-grey mb-5">Media penyelenggaraan SDI, mulai dari perencanaan, pengumpulan, pemeriksaan, dan penyebarluasan data sesuai amanah Perpres 39 tahun 2019 tentang Satu Data Indonesia.</p>
